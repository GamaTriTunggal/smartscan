...
export const geofenceIntermediateTour = {
  id: 'geofence-intermediate',
  name: 'Using Geofence (Intermediate Tier)',
  description: 'Learn how to set up distribution zone geofencing for grey market detection. This is the intermediate tier version — Pro tier adds zone templates for faster setup.',
  estimatedMinutes: 5,
  ...
  steps: [
    ...
    // ── Step 5: Search Semarang ──
    // (No zone template step — intermediate tier doesn't have zone templates)
    {
    ...
    // ── Step 9: Search batch on ProductBatchHistoryPage ──
    {
    ...
    // ── Step 11: Click "Edit Geofence Zone" ──
    {
    ...
    // ── Step 12: Change Radius to 70 km ──
    {
